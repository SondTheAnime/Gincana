  ...
  const renderPlayerCard = (player: FutsalPlayer) => (
    ...
    >
      ...
      <div className="mt-3 grid grid-cols-3 gap-2 text-center text-xs">
        <div>
          <div className="text-gray-500 dark:text-gray-400">Gols</div>
        ...
        {player.position === 'Goleiro' ? (
          <div>
            <div className="text-gray-500 dark:text-gray-400">Defesas</div>
            <div className="font-medium text-gray-900 dark:text-white">
              {player.stats.saves}
            </div>
          </div>
          ...
          <div>
            <div className="text-gray-500 dark:text-gray-400">Minutos</div>
            <div className="font-medium text-gray-900 dark:text-white">
